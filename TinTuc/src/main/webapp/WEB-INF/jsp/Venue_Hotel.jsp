...
<t:templetepage>
	...
	<jsp:body>
	  <link href="/resources/Modules/TopicArticleDisplay.css" rel="stylesheet" type="text/css" />
...
<div class="bg_display">
    <div class="display" style="float: left; width: 100%;">
        <div class="title_display">
             <a style='color:#666;' href=index7c70.html?TopicId=fd0c4c9e-429c-4e2e-a19d-4236dd56945a>vennue and hotel </a> 
        </div>
...
<a href="<c:url value="/edit-webpage-${venuehotel.page_id}-${'venuehotel'}"/>"
				class="btn btn-primary " id="edtpage" style="display:none !important">
