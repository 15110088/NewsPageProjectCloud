...
<div class="bg_display">
    <div class="display" style="float: left; width: 100%;">
        <div class="title_display">
             <a style='color: #666;'
						href=index7c70.html?TopicId=fd0c4c9e-429c-4e2e-a19d-4236dd56945a>LastNew </a> 
        </div>
            ...
            <div style="margin-left: 5px; margin-bottom: 10px;">
                <div class="ct_tin_display">
                   ...
                   <div style="margin-left: 5px; margin: 15px 5px; float: left; width: 660px;">
                            ...
                            <a class="title_topicdisplay" href="/?ArticleId=26061a17-7118-4483-a711-bb569137d3af">
                                   <ul>
